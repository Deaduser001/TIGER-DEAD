...
# coding=utf-8
# coded by : Tiger-DEAD
# https://www.facebook.com/deaduser.fahim001
...
\033[1;97m         @@@••••••••••FAHIM•••••••@@@ \033[1;0m
\033[1;97m        @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m       @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m      @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;97m Author   : Tiger-DAED
\033[1;93m➤\033[1;97m Fb Id  : https://www.facebook.com/deaduser.fahim001
\033[1;97m--------------------------------------------------
"""
...
def tech_abm():
    ...
    if username =="Tiger":
        ...
        if passwordss =="Dead":
            ...
            print ("\033[1;97m[+]\033[1;92m Password : Dead\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
	    ...
	    os.system('xdg-open https://www.facebook.com/deaduser.fahim001')
            time.sleep(1)
            tech_abm()
    else:
...
def crack2():
	...
	if select=="1":
		...
		for i in z["data"]:
			...
			na=i['name']
			nm=na.rsplit(" ")[0]
			id.append(uid+'|'+nm)os.system("clear")
        print logo
        print("\033[1;91m[!] Loading Failed . Your Account Has a Checkpoint")
        os.system("rm -rf .login.txt")
        time.sleep(1)
